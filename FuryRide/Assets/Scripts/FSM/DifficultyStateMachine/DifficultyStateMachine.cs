...
public class DifficultyStateMachine : StateManager<DifficultyStateMachine.DificultyStage>
{
    ...
    [field: SerializeField, Space(20), Header("Spawners")] public EnemySpawner ZombieSpawner { get; private set; }

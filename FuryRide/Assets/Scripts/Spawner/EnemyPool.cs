...
{
    private CustomePool<SimpleZombie> _simpleZombyPool;
    ...
    public CustomePool<SimpleZombie> GetSimpleZombyPool() => _simpleZombyPool;
    ...
    {
        _simpleZombyPool = new CustomePool<SimpleZombie>(enemyFactory, 5, true);
